...
<form role="form" id="frmBulk" method="post" name="frmBoard"
	  action="${contextPath}/bulk/register">
...
<div class="form-group">
	<label>작성자</label>
	<input class="form-control" name="bwriter" placeholder="작성자를 입력해주세요" 
	...
	<%-- <textarea>와 </textarea>는 사이에 공백이 없어야
		...
		placeholder="내용을 작성해주세요"></textarea>
                    ...
                    <div style="text-align:center;">
	                    <button type="button" class="btn btn-primary py-2 px-4" id="btnRegist" data-oper="regist">등록</button>
						<button type="button" class="btn btn-primary py-2 px-4" id="btnList" data-oper="list"
								onclick="location.href='${contextPath}/bulk/list'">취소</button>
