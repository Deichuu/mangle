    ...
    <div class="container-fluid pt-5">
	    ...
	    <div class="container-fluid bg-secondary mb-5">
	        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 150px">
	            <h1 class="font-weight-semi-bold text-uppercase mb-3">1 대 1 문의 수정</h1>
	        </div>
	    </div>
	    <!-- Page Header End -->
...
<div style="text-align:center;">
	<button type="button" class="btn btn-primary py-2 px-4 btnBoard" id="btnModify" data-oper="modify">수정</button>
	<button type="button" class="btn btn-primary py-2 px-4 btnBoard" id="btnRemove" data-oper="remove">삭제</button>
	<button type="button" class="btn btn-warning py-2 px-4 btnBoard" id="btnList" data-oper="mtomboard">취소</button>	
</div>
				</form>
...
$('.btnBoard').on("click", function(e){
	...
	if(operation == "mtomboard") {
		...
		frmModify.attr("action","${contextPath}/mtomboard/list").attr("method","get");
...
/* 		if(!loginUser) {
		...
		if(operation == "modify"){ //게시물 수정 요청
			...
			$(".fileUploadResult ul li").each(function(i, obj) {
				...
				frmModify.attr("action", "${contextPath}/mtomboard/modify");
				alert("수정되었습니다.");
				
		} else if(operation == "remove"){ //게시물 삭제 요청
			frmModify.attr("action", "${contextPath}/mtomboard/delete");
