    ...
    <div class="container-fluid pt-5">
	    ...
	    <div class="container-fluid bg-secondary mb-5">
	        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 150px">
	            <h1 class="font-weight-semi-bold text-uppercase mb-3">1 대 1 문의 등록</h1>
	        </div>
	    </div>
	    <!-- Page Header End -->
...
<form role="form" name="frmBoard" method="post" action="${contextPath}/mtomboard/register" >
...
<div style="text-align:center;">	           
    <button type="button" class="btn btn-primary" id="btnRegister" data-oper="register">등록</button>
    <button type="button" class="btn btn-warning" data-oper="mtomboard"
    		onclick="location.href='${contextPath}/mtomboard/list'">취소</button>
    <sec:csrfInput/><%-- 같은건데 <sec:csrfInput/>가 더 짧음!!
