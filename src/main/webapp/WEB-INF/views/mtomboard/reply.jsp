    ...
    <div class="container-fluid pt-5">
	    ...
	    <div class="container-fluid bg-secondary mb-5">
	        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 150px">
	            <h1 class="font-weight-semi-bold text-uppercase mb-3">1 대 1 문의 답글</h1>
	        </div>
	    </div>
	    <!-- Page Header End -->
...
<form role="form" name="frmBoard" method="post" action="${contextPath}/mtomboard/reply" >
<sec:csrfInput/>
...
<div style="text-align:center;">	           
    <button type="button" class="btn btn-primary" id="btnReplyRegister" data-oper="reply">답글 등록</button>
    <button type="button" class="btn btn-warning" data-oper="mtomboard"
    		onclick="location.href='${contextPath}/mtomboard/list'">취소</button>
    <%-- <sec:csrfInput/> --%><%-- 
...
<form id="frmSendValue">
	<input type="hidden" name="rbno" id="bno" value='<c:out value="${board.bno }"/>' />
