...
public class ShopPageCreateDTO {
	private ShopPagingDTO pagingDTO;
	...
	public ShopPageCreateDTO(long totalRowCnt, ShopPagingDTO pagingDTO) {
		...
		System.out.println("기본데이터-PagingDTO2: " + pagingDTO.toString());
